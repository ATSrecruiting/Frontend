        ...
        <ul class="divide-y divide-gray-200">
          {#each cvData?.cv_data?.certifications || [] as cert, index}
            <li class="relative border-l border-gray-200 py-4 pl-8">
              ...
              {#if editingIndex === index}
                <div class="space-y-4">
                  <div class="space-y-2">
                    <label for={`certification-name-${index}`} class="block text-sm font-medium">Certification Name</label>
                    <input
                  ...
                  <div class="space-y-2">
                    <label for={`certifier-${index}`} class="block text-sm font-medium">Certifier</label>
                    <input
                      id={`certifier-${index}`}
                      type="text"
                      name="certifier"
          ...
          <li class="relative border-l border-gray-200 py-4 pl-8">
            ...
            {#if isAddingNew}
              <div class="space-y-4">
                <div class="space-y-2">
                  <label for="new-certification-name" class="block text-sm font-medium">Certification Name</label>
                  <input
                ...
                <div class="space-y-2">
                  <label for="new-certifier" class="block text-sm font-medium">Certifier</label>
                  <input
                    id="new-certifier"
                    type="text"
                    name="certifier"
