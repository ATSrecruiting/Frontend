    ...
    <ul class="divide-y divide-gray-200">
      {#each cvData?.cv_data?.work_experience || [] as workExp, index}
        <li class="relative border-l border-gray-200 py-4 pl-8">
          ...
          {#if editingIndex === index}
            ...
            <div class="space-y-4">
              <div class="space-y-2">
                <label for={`company-${index}`} class="block text-sm font-medium">Company</label>
                <input
                  id={`company-${index}`}
                  type="text"
                  name="company"
              ...
              <div class="grid grid-cols-2 gap-4">
                <div class="space-y-2">
                  <label for={`start-date-${index}`} class="block text-sm font-medium">Start Date</label>
                  <input
                    id={`start-date-${index}`}
                    type="text"
                    name="start_date"
                ...
                <div class="space-y-2">
                  <label for={`end-date-${index}`} class="block text-sm font-medium">End Date</label>
                  <input
                    id={`end-date-${index}`}
                    type="text"
                    name="end_date"
              ...
              <div class="space-y-2">
                <label for={`location-${index}`} class="block text-sm font-medium">Location</label>
                <input
                  id={`location-${index}`}
                  type="text"
                  name="location"
              ...
              <div class="space-y-2">
                <label for={`title-${index}`} class="block text-sm font-medium">Title</label>
                <input
                  id={`title-${index}`}
                  type="text"
                  name="title"
      ...
      <li class="relative border-l border-gray-200 py-4 pl-8">
        ...
        {#if isAddingNew}
          ...
          <div class="space-y-4">
            <div class="space-y-2">
              <label for="new-company" class="block text-sm font-medium">Company</label>
              <input
                id="new-company"
                type="text"
                name="company"
            ...
            <div class="grid grid-cols-2 gap-4">
              <div class="space-y-2">
                <label for="new-start-date" class="block text-sm font-medium">Start Date</label>
                <input
                  id="new-start-date"
                  type="text"
                  name="start_date"
              ...
              <div class="space-y-2">
                <label for="new-end-date" class="block text-sm font-medium">End Date</label>
                <input
                  id="new-end-date"
                  type="text"
                  name="end_date"
            ...
            <div class="space-y-2">
              <label for="new-location" class="block text-sm font-medium">Location</label>
              <input
                id="new-location"
                type="text"
                name="location"
            ...
            <div class="space-y-2">
              <label for="new-title" class="block text-sm font-medium">Title</label>
              <input
                id="new-title"
                type="text"
                name="title"
