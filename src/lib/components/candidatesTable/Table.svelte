    ...
    <div class="p-12 flex justify-center items-center">
      <div class="text-center">
        {#if searchQuery}
          ...
          <p class="text-xl font-medium text-gray-700 mb-2">No results found</p>
          <p class="text-gray-500 mb-6">Try adjusting your search query</p>
          <button
      ...
      <div class="hidden sm:block">
        <p class="text-sm text-gray-700">
          Showing <span class="font-medium"
            >{currentPage === 1 ? "1" : (currentPage - 1) * pageSize + 1}</span
          >
          to
          <span class="font-medium"
            >{Math.min(currentPage * pageSize, totalCandidates)}</span
          >
