<script lang="ts">
  ...
  function handleDeleteGrowth(index: number) {
    if (cvData.cv_data.personal_growth) {
      ...
      cvData.cv_data.personal_growth = cvData.cv_data.personal_growth.filter(
  ...
  function toggleSkillInNew(skill: string) {
    if (newPersonalGrowth.skills_gained.includes(skill)) {
      newPersonalGrowth.skills_gained = newPersonalGrowth.skills_gained.filter(
        (s) => s !== skill,
      );
    } else {
      newPersonalGrowth.skills_gained = [
        ...newPersonalGrowth.skills_gained,
        skill,
      ];
    }
  ...
  function toggleSkillInEdit(skill: string) {
    if (editFormData.skills_gained.includes(skill)) {
      editFormData.skills_gained = editFormData.skills_gained.filter(
        (s) => s !== skill,
      );
    } else {
  ...
  function addCustomSkillToNew() {
    if (
      newCustomSkill &&
      !newPersonalGrowth.skills_gained.includes(newCustomSkill)
    ) {
      newPersonalGrowth.skills_gained = [
        ...newPersonalGrowth.skills_gained,
        newCustomSkill,
  ...
  function addCustomSkillToEdit() {
    if (
      editCustomSkill &&
      !editFormData.skills_gained.includes(editCustomSkill)
    ) {
      editFormData.skills_gained = [
        ...editFormData.skills_gained,
        editCustomSkill,
      ];
      editCustomSkill = "";
              ...
              <div class="space-y-4">
                ...
                <div class="space-y-2">
                  <label
                    ...
                    >Description/Key Learnings</label
                  >
                  <textarea
                ...
                <div class="space-y-2">
                  <label for="skills-gained-edit" class="block text-sm font-medium"
                    >Skills Gained/Improved</label
                  >
                  <div id="skills-gained-edit" class="flex flex-wrap gap-2">
        ...
        >
          ...
          {#if isAddingNew}
            <div class="space-y-4">
              <!-- Add New Form -->
              <div class="space-y-2">
                <label for="new-area-of-focus" class="block text-sm font-medium"
                  >Area of Focus</label
                >
                <input
              ...
              <div class="space-y-2">
                <label for="new-description" class="block text-sm font-medium"
                  >Description/Key Learnings</label
                >
                <textarea
                  id="new-description"
              ...
              <div class="space-y-2">
                <label for="skills-gained-new" class="block text-sm font-medium"
                  >Skills Gained/Improved</label
                >
                <div id="skills-gained-new" class="flex flex-wrap gap-2">
                  {#each defaultSkills as skill}
                    <div
                      class="inline-flex items-center rounded-full bg-gray-100 px-3 py-1 text-sm"
                    >
                      <input
                        ...
                        id={`new-skill-${skill}`}
                        class="mr-2"
                        checked={newPersonalGrowth.skills_gained.includes(
                          skill,
                        )}
