<script lang="ts">
  ...
  import {
    getWorkExperienceVerifications,
    getCandidateWorkExperience,
    getCandidateWorkExperienceAttachments,
  } from "$lib/services/candidates";
  import type {
    VerificationDetailResponse,
    GetCandidateWorkExperienceResponse as Experience,
    ListAttachmentsResponse as Attachments,
...
<div class="min-h-screen bg-background">
  <ExperienceHeader {candidateId} {verifications} />
  ...
  <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <ExperienceSidebar {attachments} {verifications} {openDocumentCarousel} />
    </div>
  </div>
</div>
